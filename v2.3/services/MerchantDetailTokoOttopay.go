...
func (svc *Service) MerchantDetailTokoOttopay(bearer string, req models.MerchantDetailQRISReq, res *models.Response) {
	...
	res.Data = models.MerchantDetailTokoOttopayV23Res{
		...
		AddressProvinceId: 	dataRose.AddressProvinceId,
		AddressCityId: 		dataRose.AddressCityId,
		AddressDistrictId: 	dataRose.AddressDistrictId,
		AddressVillageId: 	dataRose.AddressVillageId,
	}
	return
}
