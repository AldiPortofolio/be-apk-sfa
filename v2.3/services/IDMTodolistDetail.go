...
// IDMTodolistDetail ..
func (svc *Service) IDMTodolistDetail(bearer string, req models.TodolistDetailReq, res *models.Response) {
	fmt.Println(">>> IDMTodolistDetail - Service <<<")
	...
	dataDB, erry := postgres.IDMGetDetailTodolist(req)
	...
	data := models.TodolistDetailRes{
		...
		IdCard:             dataDB[0].IdCard,
		Notes:              dataDB[0].Notes,
		Task:               taskTodolist,
	}
