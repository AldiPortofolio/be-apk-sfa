...
// @ID CallPlan Merchant List v2.5
// @Tags OTTO SFA
// @Router /v2.5/sfa/call_plan/merchant/list [post]
// @Accept json
// @Produce json
// @Param Authorization header string true "Bearer <token>"
// @Param Body body models.CallPlanMerchantListReq true "Body"
// @Success 200 {object} models.Response{data=models.CallPlanMerchantListResV24} "CallPlan Merchant List Response EXAMPLE"
