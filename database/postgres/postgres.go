...
// DbEnv ..
// type DbEnv struct {
// 	DbUser   	string `envconfig:"DB_POSTGRES_USER" default:"ubuntu"`
// 	DbPass   	string `envconfig:"DB_POSTGRES_PASS" default:"Ubuntu!23"`
// 	DbName   	string `envconfig:"DB_POSTGRES_NAME" default:"otto-sfa-admin-api_copy_production"`
// 	DbAddres 	string `envconfig:"DB_POSTGRES_ADDRESS" default:"13.229.6.53"`
...
type DbEnv struct {
	...
	DbPass    string `envconfig:"DB_POSTGRES_PASS" default:"sfa32021"`
